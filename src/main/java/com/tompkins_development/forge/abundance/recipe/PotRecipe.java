...
public class PotRecipe implements Recipe<SimpleContainer> {
    ...
    public PotRecipe(ResourceLocation id, ItemStack output,
    ...
    public static class Serializer implements RecipeSerializer<PotRecipe> {
        ...
        public static final ResourceLocation ID =
                new ResourceLocation(AbundanceMod.MOD_ID,"pot");

        @Override
        public PotRecipe fromJson(ResourceLocation id, JsonObject json) {
        ...
        @Override
        public PotRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
