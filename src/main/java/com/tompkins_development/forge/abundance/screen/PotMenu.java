...
import com.tompkins_development.forge.abundance.screen.slot.ModResultSlot;
...
public class PotMenu extends AbstractContainerMenu {
    ...
    public PotMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
    ...
    public PotMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.blockEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(handler -> {
            this.addSlot(new SlotItemHandler(handler, 0, 40, 19));
            this.addSlot(new SlotItemHandler(handler, 1, 64, 19));
            this.addSlot(new SlotItemHandler(handler, 2, 52, 41));
            this.addSlot(new ModResultSlot(handler, 3, 125, 31));
        });
    ...
    public int getScaledProgress() {
        ...
        System.out.println((progress * progressArrowSize / maxProgress));
